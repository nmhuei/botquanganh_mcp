...
DEFAULT_TIMEOUT_SECONDS = max(1, int(os.getenv("DEFAULT_TIMEOUT_SECONDS", "60")))
MAX_TIMEOUT_SECONDS = max(DEFAULT_TIMEOUT_SECONDS, int(os.getenv("MAX_TIMEOUT_SECONDS", "300")))
