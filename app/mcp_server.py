...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "Step 2: If continuing past work, call 'host_workspace_bind(resume_id=...)' "
        "(or 'host_workspace_bind()'). If starting fresh, call "
        "'host_workspace_bind(new=True, label=\"optional_name\")'. "
